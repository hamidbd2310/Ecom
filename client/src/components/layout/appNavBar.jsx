...
const AppNavBar = () => {
    ...
    <>
        <div className="container-fluid text-white p-2 bg-success">
            ...
            <span>
                <span className="f-12"><i className="bi bi-envelope"></i> Support@amaderstore.com </span>
                <span className="f-12 mx-2"><i className="bi bi-phone"></i> 01971371852 </span>
                </span>
            </div>
            <div className="col-md-6">
            <span className="float-end">
                <span className="bodySmal mx-1"><i className="bi bi-whatsapp"></i></span>
                <span className="bodySmal mx-1"><i className="bi bi-youtube"></i></span>
                <span className="bodySmal mx-1"><i className="bi bi-facebook"></i></span>
            </span>
            </div>
            </div>
            </div>
        ...
        <nav className="navbar sticky-top bg-white navbar-expand-lg navbar-light py-3">
            <div className="container">
            <Link className="navbar-brand" to="/"><img className="img-fluid" src={logo} alt="" width="60px" /></Link>
            ...
            <button className="btn btn-outline-dark" type="submit"><i class="bi bi-search"></i></button>
            </div>
