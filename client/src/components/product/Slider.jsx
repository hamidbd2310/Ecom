                    ...
                    <div className="carousel-indicators">
                        {
                            SliderList.map((item, i) => {
                                return (<button key={i} type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to={i} className="active" aria-current="true" aria-label=""></button>)
                            })
                        }
                    </div>
                                        ...
                                        <div className="container ">
                                            <div className="row justify-content-center">
                                                <div className="col-12 col-lg-5 col-sm-12 col-md-5 p-5">
                                                    ...
                                                    <p>{item['des']}</p>
                                                    <div className="text-white btn-outline-success my-1"><span>Price : {item['price']}</span></div>
                                                    <Link to={`/details/${item["_id"]}`} className="btn text-white btn-primary px-5">Buy Now</Link>
